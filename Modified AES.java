...
public class ModifiedAES {
    ...
    public static List<List<List<Integer>>> kExpa(ArrayList<Integer> g) {
        ...
        while (ck.size() < (tr + 1) * 4) {
            ...
            if (ck.size() % ts == 0) {
                ...
                wd.set(0, wd.get(0) ^ (gMul(RCM.get(f), ab(2, 5))));
                f = f + 1;
    ...
    public static void printBanner() {
        ...
        System.out.println("Group Code: (A,B) = (7,7) with r(j)=(01111110)*((00000010)^(j-1))");
        ...
        System.out.println("------------------------------------------------------------------------------------");
        System.out.println("Modified AES with Group Code (7,7)");
        System.out.println("------------------------------------------------------------------------------------");
